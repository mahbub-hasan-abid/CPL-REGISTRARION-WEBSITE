...
class UploadSuccessfulScreen extends StatefulWidget {
  ...
  @override
  State<UploadSuccessfulScreen> createState() => _UploadSuccessfulScreenState();
}

class _UploadSuccessfulScreenState extends State<UploadSuccessfulScreen>
            ...
            child: Column(
              children: [
                    ...
                    child: Column(
                      children: [
                        AspectRatio(
                          aspectRatio: 1,
                          child: Lottie.asset(
                            'assets/celebratation.json', // Add the correct path to your Lottie animation file
                            animate: true,
                        ...
                        AspectRatio(
                          aspectRatio: 1,
                          child: Lottie.asset(
                            'assets/thumsup.json', // Add the correct path to your Lottie animation file
                            animate: true,
                            fit: BoxFit.scaleDown,
                ...
                ErrorInfo(
                  ...
                  description:
                      "Your file has been uploaded successfully. Thank you for your submission! \n Stay connected with us! All updates will be posted on our Facebook page.",
